...
class DifferentialEvolutionSolver(object):
    ...
    def init_population_given(self):
        """
        Load the saved population
        """
        self.population = pickle.load(open("diff_evo.dat", "rb"))
    ...
    def solve(self):
        ...
        for nit in xrange(1, self.maxiter + 1):
            ...
            pickle.dump(self.population, open("diff_evo.dat", "wb"))
